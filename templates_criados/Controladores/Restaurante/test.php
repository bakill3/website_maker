      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 site-animate mb-5">
            <h4 class="site-sub-title"><!--Titulo_Sobre_sub--><?php echo $GLOBALS['titulo']; ?></h4>
            <h2 class="site-primary-title display-4"><!--Titulo_Sobre--><!--Titulo_Sobre_sub--><!--fim_Titulo_Sobre--><?php echo $GLOBALS['titulo']; ?></h2>
           

            <!--P_Titulo_Sobre--><p class="mb-4"><?php echo $GLOBALS['info']; ?><!--P_Titulo_Sobre_sub--></p><!--fim_P_Titulo_Sobre-->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center mb-5 site-animate">
            <h2 class="display-4"><?php echo $GLOBALS['titulo']; ?></h2>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead"><?php echo $GLOBALS['info']; ?></p>
              </div>
            </div>
          </div>
...
<section class="site-section bg-light" id="section-offer">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center mb-5 site-animate">
            <h4 class="site-sub-title"><?php echo $GLOBALS['titulo']; ?></h4>
            <h2 class="display-4"><?php echo $GLOBALS['titulo']; ?></h2>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead"><?php echo $GLOBALS['info']; ?></p>
