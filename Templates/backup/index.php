...
<html lang="en">
  <head>
    <title><?php if (isset($titulo_main)) { echo $titulo_main; } ?></title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target="#site-navbar" data-offset="200">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-dark site-navbar-light" id="site-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.html"><!--Titulo--><!--Titulo_sub--><!--fim_Titulo--></a>
        ...
        <div class="collapse navbar-collapse" id="site-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <!--Especialidades--><li class="nav-item"><a href="#section-offer" class="nav-link">Especialidades</a></li><!--fim_Especialidades-->
            <!--Menu--><li class="nav-item"><a href="#section-menu" class="nav-link">Menu</a></li><!--fim_Menu-->
            <!--Notícias--><li class="nav-item"><a href="#section-news" class="nav-link">Notícias</a></li><!--fim_Notícias-->
            <!--Galeria--><li class="nav-item"><a href="#section-gallery" class="nav-link">Galeria</a></li><!--fim_Galeria-->
            <!--Contactos--><li class="nav-item"><a href="#section-contact" class="nav-link">Contactos</a></li><!--fim_Contactos-->
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section class="site-cover" style="background-image: url(images/bg_3.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
          <div class="col-md-12">
            <h1 class="site-heading site-animate mb-3">Bem-Vindo ao <!--Titulo--><!--Titulo_sub--><!--fim_Titulo--></h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 site-animate mb-5">
            <h4 class="site-sub-title"><!--Titulo_Sobre_sub--><?php if (isset($sobre_titulo)) { echo $sobre_titulo; } ?></h4>
            <h2 class="site-primary-title display-4"><!--Titulo_Sobre--><!--Titulo_Sobre_sub--><!--fim_Titulo_Sobre--><?php if (isset($sobre_titulo)) { echo $sobre_titulo; } ?></h2>
           

            <!--P_Titulo_Sobre--><p class="mb-4"><?php if (isset($sobre_info)) { echo $sobre_info; } ?><!--P_Titulo_Sobre_sub--></p><!--fim_P_Titulo_Sobre-->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center mb-5 site-animate">
            <h4 class="site-sub-title"><!--Titulo_Especialidades_sub--><?php if (isset($especialidades_titulo)) { echo $especialidades_titulo; } ?></h4>
            <h2 class="display-4"><!--Titulo_Especialidades_sub--><?php if (isset($especialidades_titulo)) { echo $especialidades_titulo; } ?></h2>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead"><!--info_Especialidades_sub--><?php if (isset($especialidades_info)) { echo $especialidades_info; } ?></p>
              </div>
            </div>
          </div>
          <div class="col-md-12">
    ...
    <section class="site-section" id="section-menu">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center mb-5 site-animate">
            <h2 class="display-4"><!--Titulo_Menu_sub--><?php if (isset($menu_titulo)) { echo $menu_titulo; } ?></h2>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead"><!--Info_Menu_sub--><?php if (isset($menu_info)) { echo $menu_info; } ?></p>
              </div>
            </div>
          </div>
    ...
    <section class="site-section bg-light" id="section-news">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center mb-5 site-animate">
            <h2 class="display-4"><!--Titulo_Noticias_sub--><?php if (isset($noticias_titulo)) { echo $noticias_titulo; } ?></h2>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead"><!--Info_Noticias_sub--><?php if (isset($noticias_info)) { echo $noticias_info; } ?></p>
              </div>
            </div>
          </div>
    ...
    <section class="site-section" id="section-gallery">
      <div class="container">
        <div class="row site-custom-gutters">
          ...
          <div class="col-md-12 text-center mb-5 site-animate">
            <h2 class="display-4"><!--Titulo_Galeria_sub--><?php if (isset($galeria_titulo)) { echo $galeria_titulo; } ?></h2>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead"><!--Info_Galeria_sub--><?php if (isset($galeria_info)) { echo $galeria_info; } ?></p>
              </div>
            </div>
          </div>
    ...
    <section class="site-section bg-light" id="section-contact">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 text-center mb-5 site-animate">
            <h2 class="display-4"><!--Titulo_Contactos_sub--><?php if (isset($contactos_titulo)) { echo $contactos_titulo; } ?></h2>
            <div class="row justify-content-center">
              <div class="col-md-7">
                <p class="lead"><!--Info_Contactos_sub--><?php if (isset($contactos_info)) { echo $contactos_info; } ?></p>
              </div>
            </div>
          </div>
